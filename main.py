...
def get_modern_template():
    """生成符合 1.12.x 标准的零警告、高性能 gVisor 配置模板"""
    return {
        ...
        "inbounds": [{
            ...
            "auto_route": True,
            "strict_route": True,
            # --- 优化点：stack 设置为 gvisor (g)，并提升 MTU 性能 ---
            "stack": "gvisor", 
            "mtu": 9000,
            "sniff": True,
...
def main():
    print("🚀 Sing-box 1.12.x 优化版生成器启动...")
    print("🛠️ 协议栈已设定为: gVisor (高速/高稳定性)")
    ...
    print(f"⚡ 正在对 {len(nodes_to_test)} 个节点进行测速...")
