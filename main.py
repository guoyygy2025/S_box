...
def generate_config(valid_nodes: List[Dict]) -> Dict:
    ...
    used_tags = set([o["tag"] for o in outbounds])
    proxy_tags = []
    ...
    return {
        ...
        "dns": {
            ...
            "fakeip": {
                "enabled": True,
                "inet4_range": "198.18.0.0/15" # 🟢 修复核心报错
            }
        },
        "inbounds": [{
            "type": "tun",
...
def main():
    ...
    logger.info(f"🎉 成功！config.json 已生成，包含 {len(valid_nodes)} 个节点。")
